...
### 📊 GitHub Stats
<p align="left">
<img src="https://github-readme-stats.vercel.app/api?username=Bui-Thanh-Liem&show_icons=true&theme=radical" alt="Liem's GitHub Stats" />
</p>
...
- **Key Task:** Optimized complex SQL queries (latency < 200ms) and implemented BullMQ for background jobs.
- **Stack:** `NestJS`, `MySQL`, `Redis`, `BullMQ`, `Docker`.

#### 📱 Social Media Web Application
- **Highlights:** Handled high concurrency (>10,000 req/s) and real-time features.
- **Stack:** `Express.js`, `MongoDB`, `Redis`, `Socket.io`, `AWS`.

---

### 📫 Contact Info
- 📞 **Phone:** +084 375 255 073
